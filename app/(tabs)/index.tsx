...
export default function HomeScreen() {
  ...
  const handleViewAllBrands = () => {
    navigateTo('/(tabs)/brands' as any);
  };

  const handleOrder = () => {
    navigateTo('/(tabs)/create-order');
  };
        ...
        <View style={styles.brandsSection}>
          ...
          >
            {brands.map((brand) => (
              ...
              >
                <Image 
                  source={brand.image_url ? { uri: brand.image_url } : { uri: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg' }}
        ...
        <View style={styles.productsSection}>
          ...
          <FlatList
            ...
            renderItem={({ item: product }) => (
              ...
              >
                <Image 
                  source={{ uri: product.image_url || 'https://images.pexels.com/photos/264636/pexels-photo-264636.jpeg' }} 
